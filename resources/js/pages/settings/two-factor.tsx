                    ...
                    {twoFactorEnabled ? (
                        <div className="flex flex-col items-start justify-start space-y-4">
                            ...
                            <p className="text-muted-foreground">
                                ...
                                solicitado a inserir um PIN seguro e aleatório durante
                                o login, que pode ser obtido no aplicativo autenticador
                        ...
                        <div className="flex flex-col items-start justify-start space-y-4">
                            ...
                            <p className="text-muted-foreground">
                                ...
                                Este PIN pode ser obtido de um aplicativo autenticador
                                compatível com TOTP no seu celular.
                            </p>
